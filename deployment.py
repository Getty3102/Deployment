...
if app_mode == "Prediction section":
    ...
    st.write("People frequently have difficulty distinguishing between Alzheimer's and dementia. To have a better grasp of the two, watch the video below.")
